...
template <> constexpr inline auto ControlPanel::qt_create_metaobjectdata<qt_meta_tag_ZN12ControlPanelE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "",
        "onSupportChanged",
        "onLoadMagnitudeChanged",
        "val",
        "onUDLToggled",
        "on",
        "onUDLIntensityChanged",
        "onBeamLengthChanged"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onSupportChanged'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onLoadMagnitudeChanged'
        ...
        // Slot 'onUDLIntensityChanged'
        QtMocHelpers::SlotData<void(int)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 5 },
        }}),
        // Slot 'onBeamLengthChanged'
...
void ControlPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onSupportChanged(); break;
        case 2: _t->onLoadMagnitudeChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->onUDLToggled((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 4: _t->onUDLIntensityChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 5: _t->onBeamLengthChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ControlPanel::*)()>(_a, &ControlPanel::parametersChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void ControlPanel::parametersChanged()
{
